...
for file_path in song_files:
    try:
        ...
        # Add optimal line-height: 1.6 for best readability
        # Match .stanza block and add line-height after white-space
        old_pattern = r'(\.stanza \{\s+margin-bottom: 1em;\s+white-space: pre-line;)'
        new_replacement = r'\1\n  line-height: 1.6;'
