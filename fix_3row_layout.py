...
Line 1: Back button + Song title
Line 2: Previous + Next buttons
Line 3: Font controls + PDF button
"""
...
def update_song_file(filepath):
    ...
    try:
        ...
        # Update CSS for 3-row layout
        old_css_pattern = r'/\* Compact Header Layout \*/.*?(?=\.lyrics-container)'
...
'''
        ...
        html_pattern = r'<div class="page-header">.*?</div>\s*</div>'
